            ...
            <div className="mt-2 pt-2 border-t border-amber-900/40 grid grid-cols-1 gap-1.5 animate-fade-in">
              ...
              {onOpenNotebook && (
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2 rounded-xl bg-amber-950/70 hover:bg-amber-900/80 border border-amber-400/50 text-amber-200 text-xs font-serif transition-all active:scale-[0.99] group text-left cursor-pointer"
                >
                  <div className="flex items-center gap-2">
                    <NotebookPen className="w-3.5 h-3.5 text-amber-300 shrink-0" />
                    <span className="font-bold">Caderno de Anotações do Investigador</span>
                  </div>
                  <ArrowRight className="w-3.5 h-3.5 text-amber-400/70 group-hover:translate-x-0.5 transition-transform shrink-0" />
                </button>
              )}
