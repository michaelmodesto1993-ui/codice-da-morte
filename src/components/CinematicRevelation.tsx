...
import { ChronicleShareModal } from './ChronicleShareModal';
...
export const CinematicRevelation: React.FC<CinematicRevelationProps> = ({
  ...
  const [showChronicleModal, setShowChronicleModal] = useState<boolean>(false);
  ...
  // Sound triggers, haptics & Level/Coin progression rewards on mount
  useEffect(() => {
          ...
          <div className="w-full space-y-2 pt-1">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-3">
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-amber-950/80 hover:bg-amber-900 border border-amber-500/50 text-[11px] font-serif font-black text-amber-300 hover:text-white uppercase tracking-wider flex items-center gap-1.5 shadow-md active:scale-95 transition-all"
              >
                <Scroll className="w-3.5 h-3.5 text-amber-400" />
                <span>Partilhar Crônica</span>
              </button>
              <button
                onClick={() => {
                  soundEngine.playClick();
        ...
        <div className="relative z-10 max-w-3xl mx-auto w-full space-y-4 py-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-amber-950/80 hover:bg-amber-900 border border-amber-500/50 text-amber-300 hover:text-white font-serif font-black text-xs uppercase tracking-wider shadow-lg active:scale-95 flex items-center gap-2"
            >
