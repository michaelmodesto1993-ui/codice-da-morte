      ...
      >
        ...
        {onOpenNotebook && (
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-gradient-to-r from-[#1c1404] to-[#0c0802] hover:from-[#2c1f08] hover:to-[#160f04] border border-amber-400/60 text-amber-200 text-[11px] font-serif font-bold uppercase tracking-wider transition-all shadow-md group active:scale-95"
          >
            <NotebookPen className="w-3.5 h-3.5 text-amber-300 group-hover:scale-110 transition-transform shrink-0" />
            <span className="truncate">Caderno de Notas</span>
          </button>
        )}
